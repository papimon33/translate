...
const FLOOR_SHADE = { '1F':0.88, '2F':0.92, '3F':0.96, '4F':1.00 };
const SIDE_GRAD = 0.34;   // 바닥 측면 하단 그림자(그라데이션) 강도 0~1 — 입체 두께 강조
// 라벨(콜아웃) — 작게 + 반투명 + 그림자로 가림 최소화.
const LABEL = { fs:11.5, h:20, padX:13, tail:6, rx:10, bgOpacity:0.92 };
// 시설 아이콘 — 흰 배경 프레임 + 그림자로 어두운 배경에서 분리.
const ICON = { size:22, frame:2.6, rx:6.5, bg:'#ffffff', edge:'rgba(20,28,40,0.14)', edgeW:0.75 };
