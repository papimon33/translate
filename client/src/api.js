...
export const api = {
  ...
  adminDeleteDeskLog: (sid, idx, endedAt) => fetch(`/api/admin/logs/desk/${encodeURIComponent(sid)}/${idx}${endedAt ? `?endedAt=${endedAt}` : ''}`, { method: 'DELETE' }).then(json), // endedAt=재색인 오삭제 방지
